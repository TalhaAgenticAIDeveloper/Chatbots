...
# VOICE = voices[0]  # 2nd is for female and 3rd is for male
...
#     6. **Do not respond to queries unrelated to English language learning** (e.g., programming questions, calculations, or general knowledge). Politely redirect them by saying: "I am here to help with English language skills! Please feel free to ask about grammar, language learning, or English-related topics."
...
# # User textual input and voice conversion 
# while True:
#     try:
...
#                 conversation_history.append(f"AI Tutor: {TEXT}")
...
# Streamlit UI
st.title("AI-Powered English Tutor")
